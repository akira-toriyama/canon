...
- **chord 先行**。順序: **C1 → C2 → C3 → C4**。**C1/C2/C4 ✅ 完了**、**C3 は vkey#1 ✅ /
  runtime#2 のみ残**（Controller spine 統合テスト、テスト seam 新設が前提）。canon は
  **C5/C6 ✅ 完了**（ist 統合作業 I1/I3 と統合して回収済）、**C7 のみ残**（flash-reset.sh、削除前に user 確認）。
